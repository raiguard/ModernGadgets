  ...
  Type
    ...
    The type of information to retrieve.
      ...
      CpuThreadsPerCore
        ...
        CpuThreadsPerCore x CpuPhysicalCores = the number of logical cores.
...
;             the OnChangeAction's !SetOption bang will refresh the ActiveNet measure.
;
...
SysInfoData=Best
DynamicVariables=1
OnChangeAction=[!SetOption MeasureInterfaceName Reload 0]
...
Text="Connection: %1#CRLF#Network Adapter: %2#CRLF#In: %3B/sec#CRLF#Out: %4B/sec"
